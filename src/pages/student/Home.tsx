  ...
  return (
    <div className="w-full pb-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
        ...
        {/* Fix for iOS Interaction: Wrapped entire card in Link, added Z-index and touch-manipulation */}
        <Link
            to="/student/assignments"
            className="md:col-span-2 block relative z-30 group touch-manipulation"
        >
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-xl p-6 text-white relative overflow-hidden transform transition-all duration-200 active:scale-95 shadow-xl">
