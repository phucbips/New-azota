                                ...
                                <div className="space-y-3">
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="font-bold text-foreground flex items-center gap-2"><Banknote className="w-4 h-4"/> Tiền mặt (trả sau)</span>
                                        </div>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div key={order.id} className="bg-card rounded-2xl border border-border shadow-sm p-6 opacity-80 hover:opacity-100 transition-opacity">
                                ...
                                <div className="flex items-center justify-between pt-4 border-t border-border">
                                    <span className="text-muted-foreground text-sm">
                                        Phương thức: {order.paymentMethod === 'cash' ? 'Tiền mặt (trả sau)' : 'Chuyển khoản'}
                                    </span>
