...
export const LoginPage: React.FC = () => {
  ...
  return (
    <div className="bg-background text-foreground font-sans flex items-center justify-center min-h-screen p-[24px]">
      <Card className="w-full max-w-[420px] shadow-lg">
        <CardHeader className="flex flex-col items-center text-center pb-8 pt-10">
          <div className="flex h-[48px] w-[48px] items-center justify-center rounded-[8px] bg-primary text-white mb-6">
        ...
        <CardContent className="flex flex-col gap-6 pb-10">
          ...
          <div className="relative flex items-center w-full">
            ...
            <span className="flex-shrink-0 mx-4 text-muted-foreground text-[12px] uppercase">Or</span>
            <div className="flex-grow border-t border-border"></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-[14px] font-medium text-foreground" htmlFor="email">Email</label>
                <Input
                  id="email"
                  type="email"
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <label className="text-[14px] font-medium text-foreground" htmlFor="password">Password</label>
                  {isLogin && (
                      <a className="text-[13px] text-muted-foreground hover:text-foreground transition-colors cursor-pointer">
                          Forgot password?
                      </a>
                  )}
                </div>
