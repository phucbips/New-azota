 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var fg;function OE(){return fg||(fg=1,(function(r){function e(Z,de){var se=Z.length;Z.push(de);e:for(;0<se;){var V=se-1>>>1,G=Z[V];if(0<o(G,de))Z[V]=de,Z[se]=G,se=V;else break e}}function t(Z){return Z.length===0?null:Z[0]}function s(Z){if(Z.length===0)return null;var de=Z[0],se=Z.pop();if(se!==de){Z[0]=se;e:for(var V=0,G=Z.length,Te=G>>>1;V<Te;){var Ie=2*(V+1)-1,Re=Z[Ie],ke=Ie+1,Fe=Z[ke];if(0>o(Re,se))ke<G&&0>o(Fe,Re)?(Z[V]=Fe,Z[ke]=se,V=ke):(Z[V]=Re,Z[Ie]=se,V=Ie);else if(ke<G&&0>o(Fe,se))Z[V]=Fe,Z[ke]=se,V=ke;else break e}}return de}function o(Z,de){var se=Z.sortIndex-de.sortIndex;return se!==0?se:Z.id-de.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;r.unstable_now=function(){return l.now()}}else{var h=Date,m=h.now();r.unstable_now=function(){return h.now()-m}}var g=[],_=[],w=1,T=null,I=3,U=!1,H=!1,q=!1,B=typeof setTimeout=="function"?setTimeout:null,ie=typeof clearTimeout=="function"?clearTimeout:null,ee=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function he(Z){for(var de=t(_);de!==null;){if(de.callback===null)s(_);else if(de.startTime<=Z)s(_),de.sortIndex=de.expirationTime,e(g,de);else break;de=t(_)}}function Ce(Z){if(q=!1,he(Z),!H)if(t(g)!==null)H=!0,Nt(Be);else{var de=t(_);de!==null&&Xe(Ce,de.startTime-Z)}}function Be(Z,de){H=!1,q&&(q=!1,ie(A),A=-1),U=!0;var se=I;try{for(he(de),T=t(g);T!==null&&(!(T.expirationTime>de)||Z&&!N());){var V=T.callback;if(typeof V=="function"){T.callback=null,I=T.priorityLevel;var G=V(T.expirationTime<=de);de=r.unstable_now(),typeof G=="function"?T.callback=G:T===t(g)&&s(g),he(de)}else s(g);T=t(g)}if(T!==null)var Te=!0;else{var Ie=t(_);Ie!==null&&Xe(Ce,Ie.startTime-de),Te=!1}return Te}finally{T=null,I=se,U=!1}}var Se=!1,x=null,A=-1,k=5,b=-1;function N(){return!(r.unstable_now()-b<k)}function O(){if(x!==null){var Z=r.unstable_now();b=Z;var de=!0;try{de=x(!0,Z)}finally{de?R():(Se=!1,x=null)}}else Se=!1}var R;if(typeof ee=="function")R=function(){ee(O)};else if(typeof MessageChannel<"u"){var qe=new MessageChannel,vt=qe.port2;qe.port1.onmessage=O,R=function(){vt.postMessage(null)}}else R=function(){B(O,0)};function Nt(Z){x=Z,Se||(Se=!0,R())}function Xe(Z,de){A=B(function(){Z(r.unstable_now())},de)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(Z){Z.callback=null},r.unstable_continueExecution=function(){H||U||(H=!0,Nt(Be))},r.unstable_forceFrameRate=function(Z){0>Z||125<Z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):k=0<Z?Math.floor(1e3/Z):5},r.unstable_getCurrentPriorityLevel=function(){return I},r.unstable_getFirstCallbackNode=function(){return t(g)},r.unstable_next=function(Z){switch(I){case 1:case 2:case 3:var de=3;break;default:de=I}var se=I;I=de;try{return Z()}finally{I=se}},r.unstable_pauseExecution=function(){},r.unstable_requestPaint=function(){},r.unstable_runWithPriority=function(Z,de){switch(Z){case 1:case 2:case 3:case 4:case 5:break;default:Z=3}var se=I;I=Z;try{return de()}finally{I=se}},r.unstable_scheduleCallback=function(Z,de,se){var V=r.unstable_now();switch(typeof se=="object"&&se!==null?(se=se.delay,se=typeof se=="number"&&0<se?V+se:V):se=V,Z){case 1:var G=-1;break;case 2:G=250;break;case 5:G=1073741823;break;case 4:G=1e4;break;default:G=5e3}return G=se+G,Z={id:w++,callback:de,priorityLevel:Z,startTime:se,expirationTime:G,sortIndex:-1},se>V?(Z.sortIndex=se,e(_,Z),t(g)===null&&Z===t(_)&&(q?(ie(A),A=-1):q=!0,Xe(Ce,se-V))):(Z.sortIndex=G,e(g,Z),H||U||(H=!0,Nt(Be))),Z},r.unstable_shouldYield=N,r.unstable_wrapCallback=function(Z){var de=I;return function(){var se=I;I=de;try{return Z.apply(this,arguments)}finally{I=se}}}})(fd)),fd}var pg;function LE(){return pg||(pg=1,dd.exports=OE()),dd.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function UT(r,e){return bi(r,"POST","/v1/accounts:delete",e)}async function Xu(r,e){return bi(r,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function YT(r,e={}){return bi(r,"GET","/v2/passwordPolicy",Di(r,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lI(r,e){const t=of(r,"auth");if(t.isInitialized()){const o=t.getImmediate(),l=t.getOptions();if(gs(l,e??{}))return o;Tn(o,"already-initialized")}return t.initialize({options:e})}function uI(r,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(kr);e!=null&&e.errorMap&&r._updateErrorMap(e.errorMap),r._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function cI(r,e,t){const s=Vi(r);me(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const o=!1,l=C_(e),{host:h,port:m}=hI(e),g=m===null?"":`:${m}`,_={url:`${l}//${h}${g}/`},w=Object.freeze({host:h,port:m,protocol:l.replace(":",""),options:Object.freeze({disableWarnings:o})});if(!s._canInitEmulator){me(s.config.emulator&&s.emulatorConfig,s,"emulator-config-failed"),me(gs(_,s.config.emulator)&&gs(w,s.emulatorConfig),s,"emulator-config-failed");return}s.config.emulator=_,s.emulatorConfig=w,s.settings.appVerificationDisabledForTesting=!0,xo(h)?(e_(`${l}//${h}${g}`),t_("Auth",!0)):dI()}function C_(r){const e=r.indexOf(":");return e<0?"":r.substr(0,e+1)}function hI(r){const e=C_(r),t=/(\/\/)?([^?#/]+)/.exec(r.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",o=/^(\[[^\]]+\])(:|$)/.exec(s);if(o){const l=o[1];return{host:l,port:Mg(s.substr(l.length+1))}}else{const[l,h]=s.split(":");return{host:l,port:Mg(h)}}}function Mg(r){if(!r)return null;const e=Number(r);return isNaN(e)?null:e}function dI(){function r(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",r):r())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function k_(r,e,t=!1){if(cn(r.app))return Promise.reject(Pr(r));const s="signIn",o=await R_(r,s,e),l=await vs._fromIdTokenResponse(r,s,o);return t||await r._updateCurrentUser(l.user),l}async function II(r,e){return k_(Vi(r),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function P_(r){const e=Vi(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function SI(r,e,t){if(cn(r.app))return Promise.reject(Pr(r));const s=Vi(r),h=await Vd(s,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",wI).catch(g=>{throw g.code==="auth/password-does-not-meet-requirements"&&P_(r),g}),m=await vs._fromIdTokenResponse(s,"signIn",h);return await s._updateCurrentUser(m.user),m}function AI(r,e,t){return cn(r.app)?Promise.reject(Pr(r)):II(_t(r),Do.credential(e,t)).catch(async s=>{throw s.code==="auth/password-does-not-meet-requirements"&&P_(r),s})}function CI(r,e,t,s){return _t(r).onIdTokenChanged(e,t,s)}function RI(r,e,t){return _t(r).beforeAuthStateChanged(e,t)}function kI(r,e,t,s){return _t(r).onAuthStateChanged(e,t,s)}function po(r){return _t(r).signOut()}const ec="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function s1(r,e={}){return bi(r,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ht=(r,e)=>{const t=_e.forwardRef(({color:s="currentColor",size:o=24,strokeWidth:l=2,absoluteStrokeWidth:h,className:m="",children:g,..._},w)=>_e.createElement("svg",{ref:w,...uR,width:o,height:o,stroke:s,strokeWidth:h?Number(l)*24/Number(o):l,className:["lucide",`lucide-${cR(r)}`,m].join(" "),..._},[...e.map(([T,I])=>_e.createElement(T,I)),...Array.isArray(g)?g:[g]]));return t.displayName=`${r}`,t};/**
 * @license lucide-react v0.364.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
