const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AdminDashboard-JlhM4j2v.js","assets/ai.service-CqhRg3At.js","assets/StudentDashboard-C5xNde4D.js","assets/StudentDashboard-CAuvVr9R.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function TI(r){_o(new ds("platform-logger",e=>new OT(e),"PRIVATE")),_o(new ds("heartbeat",e=>new _I(e),"PRIVATE")),vi(Id,_g,r),vi(Id,_g,"esm2020"),vi("fire-js","")}TI("");function s_(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const II=s_,o_=new Xa("auth","Firebase",s_());/**
 * @license
