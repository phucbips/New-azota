const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AdminDashboard-D4aO15Ek.js","assets/ai.service-My6-WwX8.js","assets/StudentDashboard-ptQyhtGx.js","assets/StudentDashboard-CAuvVr9R.css"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ig;function Pw(){if(ig)return Ra;ig=1;var r=Kd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,u={key:!0,ref:!0,__self:!0,__source:!0};function h(m,g,_){var w,T={},S=null,U=null;_!==void 0&&(S=""+_),g.key!==void 0&&(S=""+g.key),g.ref!==void 0&&(U=g.ref);for(w in g)s.call(g,w)&&!u.hasOwnProperty(w)&&(T[w]=g[w]);if(m&&m.defaultProps)for(w in g=m.defaultProps,g)T[w]===void 0&&(T[w]=g[w]);return{$$typeof:e,type:m,key:S,ref:U,props:T,_owner:o.current}}return Ra.Fragment=t,Ra.jsx=h,Ra.jsxs=h,Ra}var sg;function kw(){return sg||(sg=1,rd.exports=Pw()),rd.exports}var Z=kw(),at=Kd();const Qd=Rw(at);var Au={},sd={exports:{}},Qt={},od={exports:{}},ad={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OT{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(LT(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function LT(r){const e=r.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Id="@firebase/app",_g="0.14.5";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ro=lI;function n_(r,e={}){let t=r;typeof e!="object"&&(e={name:e});const s={name:Sd,automaticDataCollectionEnabled:!0,...e},o=s.name;if(typeof o!="string"||!o)throw _i.create("bad-app-name",{appName:String(o)});if(t||(t=Yy()),!t)throw _i.create("no-options");const u=qu.get(o);if(u){if(hs(t,u.options)&&hs(s,u.config))return u;throw _i.create("duplicate-app",{appName:o})}const h=new _T(o);for(const g of Ad.values())h.addComponent(g);const m=new dI(t,s,h);return qu.set(o,m),m}function r_(r=Sd){const e=qu.get(r);if(!e&&r===Sd&&Yy())return n_();if(!e)throw _i.create("no-app",{appName:r});return e}function vi(r,e,t){let s=uI[r]??r;t&&(s+=`-${t}`);const o=s.match(/\s|\//),u=e.match(/\s|\//);if(o||u){const h=[`Unable to register library "${s}" with version "${e}":`];o&&h.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&u&&h.push("and"),u&&h.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Nr.warn(h.join(" "));return}_o(new ds(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function TI(r){_o(new ds("platform-logger",e=>new OT(e),"PRIVATE")),_o(new ds("heartbeat",e=>new _I(e),"PRIVATE")),vi(Id,_g,r),vi(Id,_g,"esm2020"),vi("fire-js","")}TI("");function o_(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const II=o_,a_=new Xa("auth","Firebase",o_());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rd(){var r;return typeof self<"u"&&((r=self.location)==null?void 0:r.href)||""}function RI(){return Ig()==="http:"||Ig()==="https:"}function Ig(){var r;return typeof self<"u"&&((r=self.location)==null?void 0:r.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function C_(r){const e=Ni(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function w0(r,e,t){if(un(r.app))return Promise.reject(Pr(r));const s=Ni(r),h=await Pd(s,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",y0).catch(g=>{throw g.code==="auth/password-does-not-meet-requirements"&&C_(r),g}),m=await ps._fromIdTokenResponse(s,"signIn",h);return await s._updateCurrentUser(m.user),m}function T0(r,e,t){return un(r.app)?Promise.reject(Pr(r)):E0(_t(r),Co.credential(e,t)).catch(async s=>{throw s.code==="auth/password-does-not-meet-requirements"&&C_(r),s})}function I0(r,e,t,s){return _t(r).onIdTokenChanged(e,t,s)}function S0(r,e,t){return _t(r).beforeAuthStateChanged(e,t)}function A0(r,e,t,s){return _t(r).onAuthStateChanged(e,t,s)}function lo(r){return _t(r).signOut()}const Qu="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bt="WebChannelConnection";class qA extends BA{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,s,o,u){const h=$d();return new Promise((m,g)=>{const _=new j_;_.setWithCredentials(!0),_.listenOnce(z_.COMPLETE,()=>{try{switch(_.getLastErrorCode()){case bu.NO_ERROR:const T=_.getResponseJson();ne(bt,`XHR for RPC '${e}' ${h} received:`,JSON.stringify(T)),m(T);break;case bu.TIMEOUT:ne(bt,`RPC '${e}' ${h} timed out`),g(new ee(B.DEADLINE_EXCEEDED,"Request time out"));break;case bu.HTTP_ERROR:const S=_.getStatus();if(ne(bt,`RPC '${e}' ${h} failed with status:`,S,"response text:",_.getResponseText()),S>0){let U=_.getResponseJson();Array.isArray(U)&&(U=U[0]);const $=U==null?void 0:U.error;if($&&$.status&&$.message){const W=function(ae){const fe=ae.toLowerCase().replace(/_/g,"-");return Object.values(B).indexOf(fe)>=0?fe:B.UNKNOWN}($.status);g(new ee(W,$.message))}else g(new ee(B.UNKNOWN,"Server responded with status "+_.getStatus()))}else g(new ee(B.UNAVAILABLE,"Connection failed."));break;default:me(9055,{l_:e,streamId:h,h_:_.getLastErrorCode(),P_:_.getLastError()})}}finally{ne(bt,`RPC '${e}' ${h} completed.`)}});const w=JSON.stringify(o);ne(bt,`RPC '${e}' ${h} sending request:`,o),_.send(t,"POST",w,s,15)})}T_(e,t,s){const o=$d(),u=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=q_(),m=$_(),g={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},_=this.longPollingOptions.timeoutSeconds;_!==void 0&&(g.longPollingTimeout=Math.round(1e3*_)),this.useFetchStreams&&(g.useFetchStreams=!0),this.jo(g.initMessageHeaders,t,s),g.encodeInitMessageHeaders=!0;const w=u.join("");ne(bt,`Creating RPC '${e}' stream ${o}: ${w}`,g);const T=h.createWebChannel(w,g);this.I_(T);let S=!1,U=!1;const $=new $A({Yo:z=>{U?ne(bt,`Not sending because RPC '${e}' stream ${o} is closed:`,z):(S||(ne(bt,`Opening RPC '${e}' stream ${o} transport.`),T.open(),S=!0),ne(bt,`RPC '${e}' stream ${o} sending:`,z),T.send(z))},Zo:()=>T.close()}),W=(z,ae,fe)=>{z.listen(ae,Te=>{try{fe(Te)}catch(ke){setTimeout(()=>{throw ke},0)}})};return W(T,Da.EventType.OPEN,()=>{U||(ne(bt,`RPC '${e}' stream ${o} transport opened.`),$.o_())}),W(T,Da.EventType.CLOSE,()=>{U||(U=!0,ne(bt,`RPC '${e}' stream ${o} transport closed`),$.a_(),this.E_(T))}),W(T,Da.EventType.ERROR,z=>{U||(U=!0,vo(bt,`RPC '${e}' stream ${o} transport errored. Name:`,z.name,"Message:",z.message),$.a_(new ee(B.UNAVAILABLE,"The operation could not be completed")))}),W(T,Da.EventType.MESSAGE,z=>{var ae;if(!U){const fe=z.data[0];Fe(!!fe,16349);const Te=fe,ke=(Te==null?void 0:Te.error)||((ae=Te[0])==null?void 0:ae.error);if(ke){ne(bt,`RPC '${e}' stream ${o} received error:`,ke);const He=ke.status;let Ne=function(C){const x=dt[C];if(x!==void 0)return Sv(x)}(He),k=ke.message;Ne===void 0&&(Ne=B.INTERNAL,k="Unknown error status: "+He+" with message "+ke.message),U=!0,$.a_(new ee(Ne,k)),T.close()}else ne(bt,`RPC '${e}' stream ${o} received:`,fe),$.u_(fe)}}),W(m,B_.STAT_EVENT,z=>{z.stat===Nd.PROXY?ne(bt,`RPC '${e}' stream ${o} detected buffering proxy`):z.stat===Nd.NOPROXY&&ne(bt,`RPC '${e}' stream ${o} detected no buffering proxy`)}),setTimeout(()=>{$.__()},0),$}terminate(){this.c_.forEach(e=>e.close()),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter(t=>t===e)}}function _d(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yE=(r,e)=>{const t=at.forwardRef(({color:s="currentColor",size:o=24,strokeWidth:u=2,absoluteStrokeWidth:h,className:m="",children:g,..._},w)=>at.createElement("svg",{ref:w,...iC,width:o,height:o,stroke:s,strokeWidth:h?Number(u)*24/Number(o):u,className:["lucide",`lucide-${sC(r)}`,m].join(" "),..._},[...e.map(([T,S])=>at.createElement(T,S)),...Array.isArray(g)?g:[g]]));return t.displayName=`${r}`,t};/**
 * @license lucide-react v0.364.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
