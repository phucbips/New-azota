const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AdminDashboard-QLwPxRQz.js","assets/ai.service-B7cx56iF.js","assets/StudentDashboard-il52leHE.js","assets/StudentDashboard-CAuvVr9R.css"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var sg;function Pw(){if(sg)return Ra;sg=1;var r=Qd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,u={key:!0,ref:!0,__self:!0,__source:!0};function h(m,g,_){var w,T={},S=null,U=null;_!==void 0&&(S=""+_),g.key!==void 0&&(S=""+g.key),g.ref!==void 0&&(U=g.ref);for(w in g)s.call(g,w)&&!u.hasOwnProperty(w)&&(T[w]=g[w]);if(m&&m.defaultProps)for(w in g=m.defaultProps,g)T[w]===void 0&&(T[w]=g[w]);return{$$typeof:e,type:m,key:S,ref:U,props:T,_owner:o.current}}return Ra.Fragment=t,Ra.jsx=h,Ra.jsxs=h,Ra}var og;function kw(){return og||(og=1,rd.exports=Pw()),rd.exports}var J=kw(),rt=Qd();const Yd=Rw(rt);var Au={},sd={exports:{}},Qt={},od={exports:{}},ad={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OT{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(LT(t)){const s=t.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(t=>t).join(" ")}}function LT(r){const e=r.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Sd="@firebase/app",vg="0.14.5";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function TI(r){_o(new ds("platform-logger",e=>new OT(e),"PRIVATE")),_o(new ds("heartbeat",e=>new _I(e),"PRIVATE")),vi(Sd,vg,r),vi(Sd,vg,"esm2020"),vi("fire-js","")}TI("");function o_(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const II=o_,a_=new Xa("auth","Firebase",o_());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wu=new Xd("@firebase/auth");function SI(r,...e){Wu.logLevel<=Re.WARN&&Wu.warn(`Auth (${Ro}): ${r}`,...e)}function Vu(r,...e){Wu.logLevel<=Re.ERROR&&Wu.error(`Auth (${Ro}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cd(){var r;return typeof self<"u"&&((r=self.location)==null?void 0:r.href)||""}function RI(){return Sg()==="http:"||Sg()==="https:"}function Sg(){var r;return typeof self<"u"&&((r=self.location)==null?void 0:r.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Co{constructor(){this.providerId=Co.PROVIDER_ID}static credential(e,t){return qa._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const s=af.parseLink(t);return pe(s,"argument-error"),qa._fromEmailAndCode(e,s.code,s.tenantId)}}Co.PROVIDER_ID="password";Co.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Co.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tl extends lf{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function v0(r,e,t=!1){const{auth:s}=r;if(un(s.app))return Promise.reject(Pr(s));const o="reauthenticate";try{const u=await $a(r,A_(s,o,e,r),t);pe(u.idToken,s,"internal-error");const h=rf(u.idToken);pe(h,s,"internal-error");const{sub:m}=h;return pe(r.uid===m,s,"user-mismatch"),ps._forOperation(r,o,u)}catch(u){throw(u==null?void 0:u.code)==="auth/user-not-found"&&wn(s,"user-mismatch"),u}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ff=-1;function gc(r){return r==null}function Xu(r){return r===0&&1/r==-1/0}function r1(r){return typeof r=="number"&&Number.isInteger(r)&&!Xu(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _f(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Xu(e)?"-0":e}}function yv(r){return{integerValue:""+r}}function N1(r,e){return r1(e)?yv(e):_f(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wc{constructor(){this._=void 0}}function D1(r,e,t){return r instanceof nc?function(o,u){const h={fields:{[Z_]:{stringValue:J_},[tv]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return u&&pf(u)&&(u=yc(u)),u&&(h.fields[ev]=u),{mapValue:h}}(t,e):r instanceof Qa?vv(r,e):r instanceof Ya?Ev(r,e):function(o,u){const h=_v(o,u),m=cy(h)+cy(o.Ae);return Od(h)&&Od(o.Ae)?yv(m):_f(o.serializer,m)}(r,e)}function x1(r,e,t){return r instanceof Qa?vv(r,e):r instanceof Ya?Ev(r,e):t}function _v(r,e){return r instanceof rc?function(s){return Od(s)||function(u){return!!u&&"doubleValue"in u}(s)}(e)?e:{integerValue:0}:null}class nc extends wc{}class Qa extends wc{constructor(e){super(),this.elements=e}}function vv(r,e){const t=wv(e);for(const s of r.elements)t.some(o=>or(o,s))||t.push(s);return{arrayValue:{values:t}}}class Ya extends wc{constructor(e){super(),this.elements=e}}function Ev(r,e){let t=wv(e);for(const s of r.elements)t=t.filter(o=>!or(o,s));return{arrayValue:{values:t}}}class rc extends wc{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function cy(r){return lt(r.integerValue||r.doubleValue)}function wv(r){return mf(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}function V1(r,e){return r.field.isEqual(e.field)&&function(s,o){return s instanceof Qa&&o instanceof Qa||s instanceof Ya&&o instanceof Ya?Eo(s.elements,o.elements,or):s instanceof rc&&o instanceof rc?or(s.Ae,o.Ae):s instanceof nc&&o instanceof nc}(r.transform,e.transform)}class O1{constructor(e,t){this.version=e,this.transformResults=t}}class En{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new En}static exists(e){return new En(void 0,e)}static updateTime(e){return new En(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function ju(r,e){return r.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(r.updateTime):r.exists===void 0||r.exists===e.isFoundDocument()}class Tc{}function Tv(r,e){if(!r.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return r.isNoDocument()?new vf(r.key,En.none()):new sl(r.key,r.data,En.none());{const t=r.data,s=Xt.empty();let o=new yt(kt.comparator);for(let u of e.fields)if(!o.has(u)){let h=t.field(u);h===null&&u.length>1&&(u=u.popLast(),h=t.field(u)),h===null?s.delete(u):s.set(u,h),o=o.add(u)}return new xi(r.key,s,new cn(o.toArray()),En.none())}}function L1(r,e,t){r instanceof sl?function(o,u,h){const m=o.value.clone(),g=dy(o.fieldTransforms,u,h.transformResults);m.setAll(g),u.convertToFoundDocument(h.version,m).setHasCommittedMutations()}(r,e,t):r instanceof xi?function(o,u,h){if(!ju(o.precondition,u))return void u.convertToUnknownDocument(h.version);const m=dy(o.fieldTransforms,u,h.transformResults),g=u.data;g.setAll(Iv(o)),g.setAll(m),u.convertToFoundDocument(h.version,g).setHasCommittedMutations()}(r,e,t):function(o,u,h){u.convertToNoDocument(h.version).setHasCommittedMutations()}(0,e,t)}function za(r,e,t,s){return r instanceof sl?function(u,h,m,g){if(!ju(u.precondition,h))return m;const _=u.value.clone(),w=fy(u.fieldTransforms,g,h);return _.setAll(w),h.convertToFoundDocument(h.version,_).setHasLocalMutations(),null}(r,e,t,s):r instanceof xi?function(u,h,m,g){if(!ju(u.precondition,h))return m;const _=fy(u.fieldTransforms,g,h),w=h.data;return w.setAll(Iv(u)),w.setAll(_),h.convertToFoundDocument(h.version,w).setHasLocalMutations(),m===null?null:m.unionWith(u.fieldMask.fields).unionWith(u.fieldTransforms.map(T=>T.field))}(r,e,t,s):function(u,h,m){return ju(u.precondition,h)?(h.convertToNoDocument(h.version).setHasLocalMutations(),null):m}(r,e,t)}function M1(r,e){let t=null;for(const s of r.fieldTransforms){const o=e.data.field(s.field),u=_v(s.transform,o||null);u!=null&&(t===null&&(t=Xt.empty()),t.set(s.field,u))}return t||null}function hy(r,e){return r.type===e.type&&!!r.key.isEqual(e.key)&&!!r.precondition.isEqual(e.precondition)&&!!function(s,o){return s===void 0&&o===void 0||!(!s||!o)&&Eo(s,o,(u,h)=>V1(u,h))}(r.fieldTransforms,e.fieldTransforms)&&(r.type===0?r.value.isEqual(e.value):r.type!==1||r.data.isEqual(e.data)&&r.fieldMask.isEqual(e.fieldMask))}class sl extends Tc{constructor(e,t,s,o=[]){super(),this.key=e,this.value=t,this.precondition=s,this.fieldTransforms=o,this.type=0}getFieldMask(){return null}}class xi extends Tc{constructor(e,t,s,o,u=[]){super(),this.key=e,this.data=t,this.fieldMask=s,this.precondition=o,this.fieldTransforms=u,this.type=1}getFieldMask(){return this.fieldMask}}function Iv(r){const e=new Map;return r.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const s=r.data.field(t);e.set(t,s)}}),e}function dy(r,e,t){const s=new Map;Fe(r.length===t.length,32656,{Re:t.length,Ve:r.length});for(let o=0;o<t.length;o++){const u=r[o],h=u.transform,m=e.data.field(u.field);s.set(u.field,x1(h,m,t[o]))}return s}function fy(r,e,t){const s=new Map;for(const o of r){const u=o.transform,h=t.data.field(o.field);s.set(o.field,D1(u,h,e))}return s}class vf extends Tc{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class b1 extends Tc{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ic{constructor(e,t,s,o,u){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=s,this.documentUpdates=o,this.resolvedLimboDocuments=u}static createSynthesizedRemoteEventForCurrentChange(e,t,s){const o=new Map;return o.set(e,ol.createSynthesizedTargetChangeForCurrentChange(e,t,s)),new Ic(ye.min(),o,new et(Ce),Vr(),Pe())}}class ol{constructor(e,t,s,o,u){this.resumeToken=e,this.current=t,this.addedDocuments=s,this.modifiedDocuments=o,this.removedDocuments=u}static createSynthesizedTargetChangeForCurrentChange(e,t,s){return new ol(s,t,Pe(),Pe(),Pe())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yd="RestConnection",zA={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class BA{get $o(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Uo=t+"://"+e.host,this.Ko=`projects/${s}/databases/${o}`,this.Wo=this.databaseId.database===Ju?`project_id=${s}`:`project_id=${s}&database_id=${o}`}Go(e,t,s,o,u){const h=qd(),m=this.zo(e,t.toUriEncodedString());ne(yd,`Sending RPC '${e}' ${h}:`,m,s);const g={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Wo};this.jo(g,o,u);const{host:_}=new URL(m),w=Ao(_);return this.Jo(e,m,g,s,w).then(T=>(ne(yd,`Received RPC '${e}' ${h}: `,T),T),T=>{throw vo(yd,`RPC '${e}' ${h} failed with error: `,T,"url: ",m,"request:",s),T})}Ho(e,t,s,o,u,h){return this.Go(e,t,s,o,u)}jo(e,t,s){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Po}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((o,u)=>e[u]=o),s&&s.headers.forEach((o,u)=>e[u]=o)}zo(e,t){const s=zA[e];return`${this.Uo}/v1/${t}:${s}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uE{constructor(e,t,s,o,u){this._firestore=e,this._userDataWriter=t,this._key=s,this._document=o,this._converter=u}get id(){return this._key.path.lastSegment()}get ref(){return new it(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new HR(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}get(e){if(this._document){const t=this._document.data.field(qf("DocumentSnapshot.get",e));if(t!==null)return this._userDataWriter.convertValue(t)}}}class HR extends uE{data(){return super.data()}}function qf(r,e){return typeof e=="string"?$f(r,e):e instanceof kc?e._internalPath:e._delegate._internalPath}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function YR(r){r=Jt(r,it);const e=Jt(r.firestore,Or);return VR(Pc(e),r._key).then(t=>fE(e,r,t))}cs._jsonSchemaVersion="firestore/querySnapshot/1.0",cs._jsonSchema={type:pt("string",cs._jsonSchemaVersion),bundleSource:pt("string","QuerySnapshot"),bundleName:pt("string"),bundle:pt("string")};class Gf extends KR{constructor(e){super(),this.firestore=e}convertBytes(e){return new vn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new it(this.firestore,null,t)}}function XR(r){r=Jt(r,vs);const e=Jt(r.firestore,Or),t=Pc(e),s=new Gf(e);return cE(r._query),OR(t,r._query).then(o=>new cs(e,s,r,o))}function JR(r,e,t){r=Jt(r,it);const s=Jt(r.firestore,Or),o=dE(r.converter,e);return Vc(s,[sE(Nc(s),"setDoc",r._key,o,r.converter!==null,t).toMutation(r._key,En.none())])}function ZR(r,e,t,...s){r=Jt(r,it);const o=Jt(r.firestore,Or),u=Nc(o);let h;return h=typeof(e=_t(e))=="string"||e instanceof kc?$R(u,"updateDoc",r._key,e,t,s):BR(u,"updateDoc",r._key,e),Vc(o,[h.toMutation(r._key,En.exists(!0))])}function gC(r){return Vc(Jt(r.firestore,Or),[new vf(r._key,En.none())])}function yC(r,e){const t=Jt(r.firestore,Or),s=Oa(r),o=dE(r.converter,e);return Vc(t,[sE(Nc(r.firestore),"addDoc",s._key,o,r.converter!==null,{}).toMutation(s._key,En.exists(!1))]).then(()=>s)}function qy(r,...e){var g,_,w;r=_t(r);let t={includeMetadataChanges:!1,source:"default"},s=0;typeof e[s]!="object"||jy(e[s])||(t=e[s++]);const o={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(jy(e[s])){const T=e[s];e[s]=(g=T.next)==null?void 0:g.bind(T),e[s+1]=(_=T.error)==null?void 0:_.bind(T),e[s+2]=(w=T.complete)==null?void 0:w.bind(T)}let u,h,m;if(r instanceof it)h=Jt(r.firestore,Or),m=_c(r._key.path),u={next:T=>{e[s]&&e[s](fE(h,r,T))},error:e[s+1],complete:e[s+2]};else{const T=Jt(r,vs);h=Jt(T.firestore,Or),m=T._query;const S=new Gf(h);u={next:U=>{e[s]&&e[s](new cs(h,S,T,U))},error:e[s+1],complete:e[s+2]},cE(r._query)}return function(S,U,$,W){const z=new Uf(W),ae=new Mf(U,z,$);return S.asyncQueue.enqueueAndForget(async()=>Vf(await lc(S),ae)),()=>{z.Nu(),S.asyncQueue.enqueueAndForget(async()=>Of(await lc(S),ae))}}(Pc(h),m,o,u)}function Vc(r,e){return function(s,o){const u=new kr;return s.asyncQueue.enqueueAndForget(async()=>wR(await xR(s),o,u)),u.promise}(Pc(r),e)}function fE(r,e,t){const s=t.docs.get(e._key),o=new Gf(r);return new us(r,o,e._key,s,new La(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){(function(o){Po=o})(Ro),_o(new ds("firestore",(s,{instanceIdentifier:o,options:u})=>{const h=s.getProvider("app").getImmediate(),m=new Or(new BS(s.getProvider("auth-internal")),new WS(h,s.getProvider("app-check-internal")),function(_,w){if(!Object.prototype.hasOwnProperty.apply(_.options,["projectId"]))throw new ee(B.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ga(_.options.projectId,w)}(h,o),h);return u={useFetchStreams:t,...u},m._setSettings(u),m},"PUBLIC").setMultipleInstances(!0)),vi(qg,Wg,e),vi(qg,Wg,"esm2020")})();const eC={apiKey:"AIzaSyBLeBmdJ85IhfeJ7sGBHOlSjUmYJ6V_YIY",authDomain:"thpt-chi-linh.firebaseapp.com",projectId:"thpt-chi-linh",storageBucket:"thpt-chi-linh.firebasestorage.app",messagingSenderId:"59436766218",appId:"1:59436766218:web:8621e33cc12f6129e6fbf3",measurementId:"G-442TZLSK9J"},pE=n_(eC),Zn=MS(pE),Ca=bR(pE),_C="",vC="https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-exp:generateContent",Pa={USERS:"users",LESSONS:"lessons"};class tC{constructor(){ng(this,"collection",MR(Ca,Pa.USERS))}async createUser(e,t){const s=Oa(Ca,Pa.USERS,e);await JR(s,{uid:e,...t,joinedAt:We.now()})}async getUser(e){const t=Oa(Ca,Pa.USERS,e),s=await YR(t);return s.exists()?s.data():null}async updateUser(e,t){const s=Oa(Ca,Pa.USERS,e);await ZR(s,t)}subscribeToUser(e,t,s){const o=Oa(Ca,Pa.USERS,e);return qy(o,h=>{h.exists()?t(h.data()):t(null)},h=>{console.error("Error subscribing to user:",h),s==null||s(h)})}async findUserByEmail(e){const t=zy(this.collection,Ed("email","==",e)),s=await XR(t);if(!s.empty){const o=s.docs[0];return{uid:o.id,...o.data()}}return null}async whitelistStudent(e){const t=await this.findUserByEmail(e);if(!t)throw new Error("Không tìm thấy người dùng. Họ phải đăng nhập ít nhất 1 lần.");if(t.isWhitelisted)throw new Error("Tài khoản đã được kích hoạt trước đó.");return await this.updateUser(t.uid,{isWhitelisted:!0,role:"student"}),!0}async removeFromWhitelist(e){await this.updateUser(e,{isWhitelisted:!1})}subscribeToWhitelistedStudents(e,t){const s=zy(this.collection,Ed("isWhitelisted","==",!0),Ed("role","==","student"));return qy(s,u=>{const h=u.docs.map(m=>({uid:m.id,...m.data()}));e(h)},u=>{console.error("Error fetching whitelisted students:",u),t==null||t(u)})}}const xu=new tC,mE=rt.createContext(void 0),nC=()=>{let r=sessionStorage.getItem("sessionId");return r||(r=crypto.randomUUID(),sessionStorage.setItem("sessionId",r)),r},rC=({children:r})=>{const[e,t]=rt.useState(null),[s,o]=rt.useState(!0),[u]=rt.useState(nC),h=rt.useCallback(async S=>{var U,$;try{const W=await xu.getUser(S.uid),z=S.email===void 0;if(W){const ae={};let fe=!1;return W.sessionId!==u&&(ae.sessionId=u,fe=!0),z&&(W.role!=="admin"||!W.isWhitelisted)&&(ae.role="admin",ae.isWhitelisted=!0,fe=!0),fe?(await xu.updateUser(S.uid,ae),{...W,...ae}):W}else{const ae={email:S.email||"",displayName:S.displayName||((U=S.email)==null?void 0:U.split("@")[0])||"User",photoURL:S.photoURL||`https://ui-avatars.com/api/?name=${($=S.email)==null?void 0:$[0]}&background=667eea&color=fff&size=200`,role:z?"admin":"student",isWhitelisted:z,sessionId:u,joinedAt:null};return await xu.createUser(S.uid,ae),{...ae,uid:S.uid}}}catch(W){return console.error("Error getting or creating user:",W),null}},[u]);rt.useEffect(()=>{let S=null;const U=A0(Zn,async $=>{S&&(S(),S=null),$?(o(!0),await h($)?S=xu.subscribeToUser($.uid,z=>{if(z){if(z.sessionId!==u){alert("Tài khoản của bạn đã được đăng nhập từ một thiết bị khác. Phiên này sẽ được đăng xuất."),sessionStorage.removeItem("sessionId"),lo(Zn);return}if(z.isActive===!1){alert("Tài khoản của bạn đã bị vô hiệu hóa."),sessionStorage.removeItem("sessionId"),lo(Zn);return}t(z)}else console.warn(`User document for ${$.uid} not found or deleted.`),lo(Zn);o(!1)},z=>{console.error("Error in user subscription:",z),lo(Zn),o(!1)}):(lo(Zn),o(!1))):(t(null),o(!1))});return()=>{U(),S&&S()}},[h,u]);const m=rt.useCallback(async()=>{const S=new Ar;try{await W0(Zn,S)}catch(U){console.error("Google sign in error:",U);let $=`Đăng nhập Google thất bại: ${U.message}`;throw U.code==="auth/popup-closed-by-user"?$="Đăng nhập bị hủy bởi người dùng.":U.code==="auth/operation-not-allowed"?$="Lỗi cấu hình Firebase: Phương thức Đăng nhập Google chưa được kích hoạt.":U.code==="auth/unauthorized-domain"&&($="Lỗi cấu hình Firebase: Tên miền ứng dụng chưa được thêm vào Authorized domains."),new Error($)}},[]),g=rt.useCallback(async(S,U)=>{try{await T0(Zn,S,U)}catch($){console.error("Email sign in error:",$);let W="Đăng nhập thất bại.";throw $.code==="auth/user-not-found"||$.code==="auth/wrong-password"||$.code==="auth/invalid-credential"?W="Email hoặc mật khẩu không chính xác.":$.code==="auth/operation-not-allowed"&&(W="Lỗi cấu hình Firebase: Phương thức Đăng nhập Email/Password chưa được kích hoạt."),new Error(W)}},[]),_=rt.useCallback(async(S,U)=>{try{await w0(Zn,S,U)}catch($){console.error("Email sign up error:",$);let W="Đăng ký thất bại.";throw $.code==="auth/weak-password"?W="Mật khẩu quá yếu (phải có ít nhất 6 ký tự).":$.code==="auth/email-already-in-use"?W="Email đã được sử dụng.":$.code==="auth/operation-not-allowed"&&(W="Lỗi cấu hình Firebase: Phương thức Đăng nhập Email/Password chưa được kích hoạt."),new Error(W)}},[]),w=rt.useCallback(async()=>{sessionStorage.removeItem("sessionId"),await lo(Zn)},[]),T={user:e,loading:s,signInWithGoogle:m,signInWithEmail:g,signUpWithEmail:_,signOut:w};return J.jsx(mE.Provider,{value:T,children:r})},gE=()=>{const r=rt.useContext(mE);if(r===void 0)throw new Error("useAuth must be used within an AuthProvider");return r};/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yE=(r,e)=>{const t=rt.forwardRef(({color:s="currentColor",size:o=24,strokeWidth:u=2,absoluteStrokeWidth:h,className:m="",children:g,..._},w)=>rt.createElement("svg",{ref:w,...iC,width:o,height:o,stroke:s,strokeWidth:h?Number(u)*24/Number(o):u,className:["lucide",`lucide-${sC(r)}`,m].join(" "),..._},[...e.map(([T,S])=>rt.createElement(T,S)),...Array.isArray(g)?g:[g]]));return t.displayName=`${r}`,t};/**
 * @license lucide-react v0.364.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
